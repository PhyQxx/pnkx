package com.pnkx.common.core.domain.entity;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.pnkx.common.annotation.Excel;
import com.pnkx.common.annotation.Excel.ColumnType;
import com.pnkx.common.annotation.Excel.Type;
import com.pnkx.common.annotation.Excels;
...
public class SysUser extends BaseEntity {
     ...
     * 文章点赞
     */
    private List<Long> articleLikeSet;

    /**
     * 评论点赞
     */
    private List<Long> commentLikeSet;
    ...
    public List<Long> getArticleLikeSet() {
        return articleLikeSet;
    }

    public void setArticleLikeSet(List<Long> articleLikeSet) {
        this.articleLikeSet = articleLikeSet;
    }

    public List<Long> getCommentLikeSet() {
        return commentLikeSet;
    }

    public void setCommentLikeSet(List<Long> commentLikeSet) {
