<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="参数类型" align="center" prop="configType" :formatter="typeFormat"/>
        ...
        <!-- 添加或修改参数配置对话框 -->
        <el-dialog :close-on-click-modal="false" :title="title" v-model="open" append-to-body width="60vw">
