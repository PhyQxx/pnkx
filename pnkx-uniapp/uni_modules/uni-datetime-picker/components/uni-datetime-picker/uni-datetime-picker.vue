<template>
  <view class="uni-date">
    ...
    <view v-if="!isPhone" v-show="pickerVisible" ref="datePicker"
      ...
      <view v-else class="uni-date-range--x" :style="pickerPositionStyle">
        ...
        <view v-if="hasTime" class="popup-x-header uni-date-changed">
          ...
          <view class="popup-x-header--datetime">
            ...
            <time-picker type="time" v-model="tempRange.endTime" :end="timepickerEndTime"
                         :border="false"
    ...
    <Calendar v-if="isPhone" ref="mobile" :clearDate="false" :date="calendarDate"
              ...
              :default-value="defaultValue"
              :pleStatus="endMultipleStatus" :showMonth="false" :range="isRange" :hasTime="hasTime"
              :insert="false"
