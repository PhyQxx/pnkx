<template>
  <view class="uni-pagination">
    <!-- #ifndef MP -->
    <picker v-if="showPageSize === true || showPageSize === 'true'" class="select-picker"
            mode="selector"
            :value="pageSizeIndex" :range="pageSizeRange" @change="pickerChange"
            @cancel="pickerClick"
    ...
    <view class="uni-pagination__num uni-pagination__num-flex-none">
      <view class="uni-pagination__num-current">
        ...
        <!-- #ifndef APP-NVUE -->
        <view v-for="(item, index) in paper" :key="index"
